...
We created a histogram that shows total number of Denny's-La Quinta combinations that are within certain distance of each other. We excluded the combination where the nearest one is more than 25 miles away. Histogram 
