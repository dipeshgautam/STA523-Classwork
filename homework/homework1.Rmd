...
# mp <- ggplot() + mapWorld + geom_point(aes(x=visit.x,y=visit.y),color=c(2:33),pch=16,size=.7*Countries$Freq, alpha= I(0.6))
# mp
...
# identifyCountries(getMap(),nameColumnToPlot="name")
```